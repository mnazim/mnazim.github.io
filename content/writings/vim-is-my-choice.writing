...
chronological : yes
kind : writing
summary : I have been using vim since I started using Linux, yet I never really used it until I took the dive about 6 months ago. Since then vim has been surprising me every single day. Now I cannot imagine using anything else. This my little vim story.
...

I have been doing programming for 8 years now(6 years professionally). Given the [lazy & dumb person][lazy-programmer] I am, I am always on a constant lookout for new tools to make my job easy by every passing day. The most important tool in your armoury as a programmer is your text editor. Why the most important? Because that's where you write the code(off course assuming you are not "[The Real Programmer][real-programmer]").
...
Then about 6 months back, I started thinking seriously about switching to either Emacs or Vim. Emacs was my first choice because I thought modal editing of Vim is just too big a PITA and always wondered [why do those nutheads used Vim][why-vim]. Least did I know, remembering a gazillion finger breaking key combinations will drive me crazy within a few days only. I have been using Vim on and off for small editing tasks and when I had ssh to remote machines, but I never tried to learn it properly.

Suddenly, one day it dawned, on me why Vim is [the perfect editor for me][vim-ninja] and I said to myself, "enough is enough, I am doing this". Thus started the my journey of Vim discovery. What follows is how I learned to work with Vim. This is in no way the holy grail of learning Vim, its just what worked for me. It might work for you or it might ruin your Vim experience forever. You have been warned. 

Every tutorial, guide or documentation I checked just scared me with all the details and Vim jargon. Moment you open these, either they bore you with how awesome Vim is or throw a long list of never ending Vim commands and modes. What I actually liked and used was this [kick ass, super awesome graphical Vim cheatsheet][vim-cheetsheet]. It taught me more about vim in 8 pages what no other tutorial/guide could. I slowly worked my way through each page, learning a page and working with it for few days until I was comfortable. Then I would move on to next page and repeat the process.
...
Believe you me, thats all how I learned Vim. No big books needed, no lengthy tutorials, no jargon. Just these 8 pages and a great virtue called patience. I still have these pages pasted on the wall in front of me when I work. Also checkout [this a nice introduction to vim][vim-intro] by [Micheal Jakl][micheal], only tutorial I know of that introduces Vim modes in 3 lines and single diagram. 
...
My vim configurations along with bash and some others, are available at [github.com/mnazim/dotfiles](http://github.com/mnazim/dotfiles). Fork it, use it the way you like. Don't forget share it back.



 [lazy-programmer]: http://blogoscoped.com/archive/2005-08-24-n14.html
 [real-programmer]: http://xkcd.com/378/
 [vim-ninja]: http://philosecurity.org/2009/03/23/pirates-and-ninjas-emacs-or-vi
 [vim-cheetsheet]: http://www.viemu.com/a_vi_vim_graphical_cheat_sheet_tutorial.html
 [why-vim]: http://www.viemu.com/a-why-vi-vim.html
 [vim-intro]: http://blog.interlinked.org/tutorials/vim_tutorial.html
 [micheal]: http://blog.interlinked.org/about/index.html
